...
class SubNet(nn.Module):
    def __init__(self, k, anchors=9, depth=4, activation=F.relu):
        ...
        #self.classification_layer_init(self.output.weight.data)
...
class RetinaNet(nn.Module):
    ...
    def __init__(self, backbone='resnet34', num_classes=20, pretrained=True):
        ...
        #self.subnet_classes=self.subnet_classes.float()
    def forward(self, x):
        input1=x
